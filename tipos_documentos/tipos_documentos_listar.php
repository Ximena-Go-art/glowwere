...
/* Ordenamiento */
$orden = isset($_GET['orden']) ? $_GET['orden'] : 'id_tipo_documento';
$direccion = (isset($_GET['dir']) && $_GET['dir'] === 'DESC') ? 'DESC' : 'ASC';

/* Consulta */

$sql = "SELECT id_tipo_documento, descripcion FROM tipos_documentos WHERE $where ORDER BY $orden $direccion";
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead style="background-color:#FFF9F5">
                        <tr>
                            <th class="ps-4">
                                <?php $nuevaDir = ($direccion === 'ASC') ? 'DESC' : 'ASC'; $sp = $_GET; $sp['orden'] = 'id_tipo_documento'; $sp['dir'] = $nuevaDir; unset($sp['pagina']); ?>
